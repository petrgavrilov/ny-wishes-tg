            ...
            <div className="instruction-pic-container">
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="m12 40.946-2.734-2.604a2.338 2.338 0 0 0-3.318 3.292l8.913 9.507a3 3 0 0 0 2.187.948H24c3.6 0 6-3 6-6V33.232"
                ></path>
                <path
                  stroke="#fff"
                  strokeLinecap="round"
            ...
            <div className="instruction-pic-container">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="m13 40.857-2.734-2.604a2.338 2.338 0 0 0-3.318 3.292l8.913 9.507a3 3 0 0 0 2.187.948H25c3.6 0 6-3 6-6V33.143"
                ></path>
                <path
                  stroke="#fff"
                  strokeLinecap="round"
